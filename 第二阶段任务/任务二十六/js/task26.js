    ...
    */
    ...
    Spaceship.prototype.dynamicManager = function() {
        ...
        var stop = function() {
            ...
            ConsoleUtil.show("阿波罗" + that.id + "号停止飞行");
        };
    ...
    Spaceship.prototype.powerManager = function() {
        ...
        var charge = function() {
            ...
            ConsoleUtil.show("阿波罗" + that.id + "号正在充电");
        };
        ...
        var discharge = function() {
            ...
            var timer = setInterval(function() {
                ...
                that.power -= dischargeRate;
            }, 20);
            ConsoleUtil.show("阿波罗" + that.id + "号正在放电");
        };
    ...
    Spaceship.prototype.stateManager = function() {
        ...
        var states = {
            ...
            destroy: function(state) {
                ...
                // AnimUtil.onDraw(that.mediator.getSpaceships());
            }
        };
        ...
        return {
            ...
            register: function(obj) {
                if (obj instanceof Commander) {
                    commander = obj;
                    obj.mediator = this;
                    ConsoleUtil.show("mediator 注册 " + "指挥官 " + obj.id);
                    return true;
                } else if (obj instanceof Spaceship) {
                    spaceships[obj.id] = obj;
                    obj.mediator = this;
                    ConsoleUtil.show("mediator 注册 " + "飞船 " + obj.id);
                    return true;
                }
                ConsoleUtil.show("mediator 注册失败");
                return false;
            },
            ...
            /**
             * getSpaceships 获取飞船队列，由于飞船队列spaceships已经封装起来，
             * 因此外界只能通过该方法获取飞船队列
             * @return {type} 返回飞船队列
             */
    ...
    var AnimUtil = (function() {
        ...
        /**
         * 动画更新时背景不用刷新，因此仅仅在初始化时绘制一次在background画布上的背景，减少计算量。
         * background画布位于screen画布下面，通过css中z-index属性进行叠加
         * @return {type} description
         */
        (function() {
        ...
        /**
         * setMediator  为AnimUtil设置Mediator，通过mediator保存的状态控制动画更
